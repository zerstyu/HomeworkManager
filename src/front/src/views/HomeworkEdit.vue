                        ...
                        <div class="card-body">
                            <div class="row icon-examples">
                                ...
                                <h2><i class="ni ni-ruler-pencil"></i> 채점</h2>
                                    ...
                                    <iframe id="homeworkCanvasIframe" name="homeworkCanvasIframe" style="display: none;width:100%;height:1000px;margin-top:-50px;" scrolling="no" src="canvas_resource/canvas.html" v-on:load="canvasOnLoad()">
                                    </iframe>
                                    </div>
                                </div>
