...
public class AssignmentFileApiController {
    ...
    @PutMapping("/assignment_files")
    public Response<List<AssignmentFile>> updateAssignmentFileList(@RequestBody List<AssignmentFileDto> assignmentFileDtoList) {
        return Response.ok(assignmentFileService.updateAssignmentFileList(assignmentFileDtoList));
    }
